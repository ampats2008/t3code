...
import Migration0019 from "./Migrations/019_ThreadForks.ts";
import Migration0020 from "./Migrations/020_ConversationFTS.ts";
...
export const migrationEntries = [
  ...
  [19, "ThreadForks", Migration0019],
  [20, "ConversationFTS", Migration0020],
] as const;
