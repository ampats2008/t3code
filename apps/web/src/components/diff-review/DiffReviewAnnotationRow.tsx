...
import { MessageSquareIcon, PencilIcon, Trash2Icon, AlertTriangleIcon } from "lucide-react";
import { useDiffReviewStore, type AnnotationSide } from "../../diffReviewStore";
...
export const DiffReviewAnnotationRow = memo(function DiffReviewAnnotationRow({
  threadId,
  filePath,
  lineNumber,
  side,
    ...
    return (
      <div className="border-l-2 border-l-primary/50 bg-muted/30 px-3 py-2.5 text-xs">
        <div className="mb-2 flex items-center gap-1.5 text-muted-foreground">
          ...
          <span className="font-medium">{isEditing ? "Edit annotation" : "Add annotation"}</span>
        </div>
        <textarea
          ref={textareaRef}
          value={inputValue}
